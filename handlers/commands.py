...
""",
        ...
        await update.message.reply_text(
            f"❌ Ошибка перевода: {str(e)[:200]}", parse_mode="Markdown"
        )
...
""",
        ...
        await update.message.reply_text(
            f"❌ Ошибка сокращения: {str(e)[:200]}", parse_mode="Markdown"
        )
...
""",
        ...
        await update.message.reply_text(
            f"❌ Ошибка объяснения: {str(e)[:200]}", parse_mode="Markdown"
        )
...
""",
        ...
        await update.message.reply_text(
            f"❌ Ошибка создания викторины: {str(e)[:200]}", parse_mode="Markdown"
        )
...
""",
        ...
        await update.message.reply_text(
            f"❌ Ошибка вычисления: {str(e)[:200]}", parse_mode="Markdown"
        )
...
""",
    ...
    try:
        ...
        await update.message.reply_text(
            f"❌ Ошибка генерации кода: {str(e)[:200]}", parse_mode="Markdown"
        )
